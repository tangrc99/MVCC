...
/// ValueNode is a typically list node. It's previous and next ptr are atomic.
class ValueNode {
public:
...
/// Class Value maintains a ValueNode list with different version to achieve MVCC. The nodes are sorted by its version.
...
/// Class ValueNodeOperation is used to partly expose private interface of ValueNode.
